...
export type StatusUpdate<T> = { finished: boolean, message: string, "percent-done": number, time: number, data: T | null, }
...
export type TestResult = {
    name: string, successful: boolean,
    /**
...
export type DownloadOrUpdateCourseExercisesResult = { downloaded: Array<ExerciseDownload>, skipped: Array<ExerciseDownload>, failed?: Array<[ExerciseDownload, Array<string>]> | null, }
...
export type CourseDetails = {
    unlockables: Array<string>, exercises: Array<Exercise>, id: number, name: string, title: string, description: string | null,
    /**
...
export type Exercise = {
    id: number, name: string, locked: boolean, deadline_description: string | null, deadline: string | null, soft_deadline: string | null, soft_deadline_description: string | null, checksum: string,
    /**
...
export type ExerciseSubmission = {
    exercise_name: string, id: number, user_id: number, course_id: number, created_at: string, all_tests_passed: boolean, points: string | null,
    /**
...
export type Review = {
    submission_id: number, exercise_name: string, id: number, marked_as_read: boolean, reviewer_name: string, review_body: string, points: Array<string>, points_not_awarded: Array<string>,
    /**
...
export type SubmissionFinished = {
    api_version: number, all_tests_passed: boolean | null, user_id: number, login: string, course: string, exercise_name: string, status: SubmissionStatus, points: Array<string>, valgrind: string | null,
    /**
     * https://tmc.mooc.fi/submissions/{submission_id}}
     */
    submission_url: string,
