...
export type Course = { id: number, name: string, title: string, description: string | null,
/**
 * /api/v8/core/courses/{course_id}
 */
details_url: string,
...
export type Course = { id: string, slug: string, name: string, description: string | null, organization_name: string, }
...
export type PublicSpec = { type: "PublicSpec", exercise_type: ExerciseType, archive_name: string, stub_download_url: string, student_file_paths: Array<string>, checksum: string, }
