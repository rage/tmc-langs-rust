...
export interface TmcStyleValidationResult { strategy: TmcStyleValidationStrategy, validation_errors: Record<string, Array<TmcStyleValidationError>> | null, }

export interface TmcStyleValidationError { column: number, line: number, message: string, source_name: string, }

export type TmcStyleValidationStrategy = "FAIL" | "WARN" | "DISABLED";

export interface SubmissionFinished { api_version: number, all_tests_passed: boolean | null, user_id: number, login: string, course: string, exercise_name: string, status: SubmissionStatus, points: Array<string>, valgrind: string | null, submission_url: string, solution_url: string | null, submitted_at: string, processing_time: number | null, reviewed: boolean, requests_review: boolean, paste_url: string | null, message_for_paste: string | null, missing_review_points: Array<string>, test_cases: Array<TestCase> | null, feedback_questions: Array<SubmissionFeedbackQuestion> | null, feedback_answer_url: string | null, error: string | null, validations: TmcStyleValidationResult | null, }
