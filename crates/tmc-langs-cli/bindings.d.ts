...
export type StatusUpdateData = { "update-data-kind": "client-update-data" } & StatusUpdate<ClientUpdateData> | { "update-data-kind": "mooc-client-update-data" } & StatusUpdate<MoocClientUpdateData> | { "update-data-kind": "mooc-device-login" } & StatusUpdate<MoocDeviceLogin> | { "update-data-kind": "none" } & StatusUpdate<null>;
...
export type LocalExercise = { "backend": "tmc" } & LocalTmcExercise | { "backend": "mooc" } & LocalMoocExercise;

export type LocalTmcExercise = { 
/**
 * The course's on-disk directory name, which is also its TMC slug.
 */
"course-slug": string, "exercise-slug": string, "exercise-id": number, "exercise-path": string, }
...
export type MoocUpdatedExercise = { id: string, }
...
export type CombinedMoocCourseData = { course: MoocCourse, slides: Array<TmcExerciseSlide>, progress: CourseProgress, }
