...
sourcesIndex["isolang"] = {"name":"","files":["lib.rs","serde_impl.rs"]};
...
sourcesIndex["neon"] = {"name":"","dirs":[{"name":"borrow","files":["internal.rs","mod.rs"]},{"name":"context","files":["internal.rs","mod.rs"]},{"name":"handle","files":["internal.rs","mod.rs"]},{"name":"macro_internal","files":["mod.rs"]},{"name":"object","dirs":[{"name":"class","files":["internal.rs","mod.rs"]}],"files":["mod.rs"]},{"name":"result","files":["mod.rs"]},{"name":"task","files":["mod.rs"]},{"name":"types","files":["binary.rs","error.rs","internal.rs","mod.rs","utf8.rs"]}],"files":["lib.rs","meta.rs","prelude.rs"]};
sourcesIndex["neon_runtime"] = {"name":"","dirs":[{"name":"nan","files":["array.rs","arraybuffer.rs","buffer.rs","call.rs","class.rs","convert.rs","error.rs","fun.rs","handler.rs","mem.rs","mod.rs","module.rs","object.rs","primitive.rs","raw.rs","scope.rs","string.rs","tag.rs","task.rs"]}],"files":["lib.rs"]};
sourcesIndex["neon_serde"] = {"name":"","files":["de.rs","errors.rs","lib.rs","macros.rs","ser.rs"]};
sourcesIndex["neon_sys"] = {"name":"","files":["lib.rs"]};
...
sourcesIndex["tmc_langs_node"] = {"name":"","files":["lib.rs"]};
