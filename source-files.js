...
sourcesIndex["oauth2"] = {"name":"","files":["basic.rs","devicecode.rs","helpers.rs","lib.rs","reqwest.rs","types.rs"]};
...
sourcesIndex["tmc_langs_cli"] = {"name":"","dirs":[{"name":"config","files":["credentials.rs","projects_config.rs","tmc_config.rs"]}],"files":["app.rs","config.rs","error.rs","main.rs","output.rs"]};
sourcesIndex["tmc_langs_csharp"] = {"name":"","files":["cs_test_result.rs","error.rs","lib.rs","plugin.rs","policy.rs"]};
sourcesIndex["tmc_langs_framework"] = {"name":"","dirs":[{"name":"file_util","files":["lock_unix.rs"]}],"files":["command.rs","domain.rs","error.rs","file_util.rs","lib.rs","meta_syntax.rs","plugin.rs","policy.rs","tmc_project_yml.rs"]};
