...
implementors["tmc_langs"] = [{"text":"impl Error for LangsError","synthetic":false,"types":[]},{"text":"impl Error for ParamError","synthetic":false,"types":[]}];
implementors["tmc_langs_csharp"] = [{"text":"impl Error for CSharpError","synthetic":false,"types":[]}];
implementors["tmc_langs_framework"] = [{"text":"impl Error for TmcError","synthetic":false,"types":[]},{"text":"impl Error for CommandError","synthetic":false,"types":[]}];
...
implementors["tmc_langs_plugins"] = [{"text":"impl Error for PluginError","synthetic":false,"types":[]}];
implementors["tmc_langs_python3"] = [{"text":"impl Error for PythonError","synthetic":false,"types":[]}];
implementors["tmc_langs_util"] = [{"text":"impl Error for FileError","synthetic":false,"types":[]}];
